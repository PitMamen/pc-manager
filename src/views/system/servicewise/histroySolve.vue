<template>
  <div style="height: 650px; ">
      ...
      <div class="div-span-content-mid">
        ...
        <div class="div-voice-wrap">
          ...
          <div class="div-voice-content">
            <div class="div-voice-item"><img src="~@/assets/icons/ly.png" class="img" />202210121134.wav</div>
            <div class="div-voice-item"><img src="~@/assets/icons/ly.png" class="img" />202210121134.wav</div>
          </div>
    ...
    <div style="display: flex; flex-direction: row-reverse">
      <a-button type="default"  style="width: 90px"> 关闭 </a-button>
    </div>
  </div>
</template>
...
export default {
  ...
  created() {
    followPlanPhoneHistory(this.patientId).then((res) => {
      if (res.code === 0) {
