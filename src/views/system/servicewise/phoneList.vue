  ...
  <a-spin :spinning="confirmLoading">
    <div class="div-service-phone">
      ...
      <div class="div-radio">
        <div
          class="radio-item"
          :class="{ 'checked-btn': queryParams.queryStatus == 1 }"
        ...
        <div
          class="radio-item"
          :class="{ 'checked-btn': queryParams.queryStatus == 2 }"
        ...
        <div
          class="radio-item"
          :class="{ 'checked-btn': queryParams.queryStatus == 3 }"
          @click="onRadioClick(3)"
        >
        ...
        <div
          class="radio-item"
          :class="{ 'checked-btn': queryParams.queryStatus == 4 }"
          @click="onRadioClick(4)"
        >
      ...
      <div style="display: flex; flex-direction: row; height: 90%">
        ...
        <a-card :bordered="true" class="card-right-phone">
          <div class="table-page-search-wrapper">
            ...
            <div
              class="search-row"
              v-if="
                queryParams.queryStatus == 2 ||
                queryParams.queryStatus == 3 ||
                queryParams.queryStatus == 4
              "
            >
            ...
            <div
              class="search-row"
              v-if="queryParams.queryStatus == 2 || queryParams.queryStatus == 4"
            >
              <span class="name">是否逾期:</span>
              <a-select
                allow-clear
                v-model="queryParams.overdueStatus"
                placeholder="请选择逾期状态"
                style="width: 120px"
              >
                <a-select-option
                  v-for="(item, index) in overdueData"
                  :key="index"
                  :value="item.code"
            ...
            <div class="search-row" v-if="queryParams.queryStatus != 4">
              ...
              <a-select
                allow-clear
                v-model="queryParams.hangStatus"
                placeholder="请选择暂挂状态"
                style="width: 120px"
              >
                <a-select-option
                  v-for="(item, index) in hangData"
                  :key="index"
                  :value="item.code"
                  >{{ item.name }}</a-select-option
                >
            ...
            <div
              class="search-row"
              v-if="queryParams.queryStatus == 3 || queryParams.queryStatus == 4"
            >
              <span class="name">状态:</span>
              <a-select
                allow-clear
                v-model="queryParams.bizStatus"
                placeholder="请选择状态"
              >
                <a-select-option
          ...
          <div style="overflow-y: auto">
            ...
            >
              <span
                ...
                :class="getClass(record.overdueStatus)"
              >
              ...
              <span
                slot="status-hang"
                slot-scope="text, record"
                :class="getzgClass(record.hangStatus)"
              >
              ...
              <span slot="action" slot-scope="text, record">
                <div
                  ...
                  class="div-action"
                  v-if="
                    (queryParams.queryStatus == 3 && record.bizStatus.value != 1) ||
                    queryParams.queryStatus == 4
                  "
                >
            ...
            if (res.code == 0) {
              res.data.rows.forEach((item, index) => {
                this.$set(
                  item,
                  "xh",
                  index + 1 + (res.data.pageNo - 1) * res.data.pageSize
                );
                ...
                if (
                  item.hangStatus &&
                  item.hangStatus != null &&
                  item.hangStatus.value &&
                  item.hangStatus.value == 1
                ) {
