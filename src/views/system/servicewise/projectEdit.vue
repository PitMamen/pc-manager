    ...
    <div class="div-project-add">
      ...
      <div class="div-pro-mission">
        ...
        >
          ...
          <div class="mission-bottom" v-if="!isMenzhen && projectData.basePlan.metaConfigureId != 21">
          ...
          <div class="mission-bottom">
            <div class="mission-bottom-left" v-if="!isMenzhen && projectData.basePlan.metaConfigureId != 21">
      ...
      for (let index = 0; index < tempData.tasks.length; index++) {
        ...
        item.stopTaskDetailDtos.forEach((itemDto) => {
          if (itemDto.stopType.value) {
            ...
            arr.push({
              stopType: itemDto.stopType.value,
              conditionValue: itemDto.conditionValue,
            })
          } else {
