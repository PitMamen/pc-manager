  ...
  <a-card :bordered="false">
    <div class="table-page-search-wrapper">
      ...
      <div class="search-row">
        ...
        <a-select
          v-model="queryParam.rightsStatus"
          allow-clear
          placeholder="请选择状态"
    ...
    >
      ...
      <span slot="action" slot-scope="text, record">
        <template v-if="true">
          <a @click="$refs.infoForm.info(record, record.orderType == 'appPreRegister' ? 6 : 5)"
            ><a-icon style="margin-right: 5px" type="hdd" />问诊记录</a
          >
        </template>
      </span>
    </s-table>
