      ...
      <div class="div-part">
        <div class="div-part-left">
          <div class="div-content">
            <span class="span-item-name"><span style="color: red">*</span>药品用法:</span>
            <a-input
...
import { add1 as add, select1 as selects } from '@/api/modular/system/ypuse'
export default {
  data() {
    return {
      visible: false,
