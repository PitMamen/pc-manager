    ...
    <a-card :bordered="false" class="top-title">
      <div class="table-page-search-wrapper">
        <div class="action-row" style="margin-top: -15px !important; margin-left: -18px">
          ...
          <span style="font-size: 14px; color: #4d4d4d">张医生待结算详情【{{ reconData }}】</span>
        </div>
      </div>
      ...
      <div class="tab-all-content">
        ...
        <div class="tab-total">
          ...
          <div class="content-dis">
            ...
            <span style="font-size: 24px; margin-top: -14px">54000</span>
          </div>
          <div class="line"></div>
          <div class="content-dis">
            <span style="font-size: 12px">总笔数：1000</span>
          </div>
        </div>
        ...
        <div class="tab-wx">
          ...
          <div class="content-dis">
            <span style="font-size: 24px; margin-top: -14px">80000</span>
          </div>
          <div class="line"></div>
          <div class="content-dis">
