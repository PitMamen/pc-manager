  ...
  <a-spin :spinning="confirmLoading">
    ...
    <div class="big-kuang">
      <div class="topimformation">
        ...
        <span style="font-weight: bold; margin-top: 10px; margin-bottom: 10px; color: #409eff">【复诊续方】</span>
      </div>
      <div class="line"></div>
      ...
      <div class="div-up-content">
        ...
        <div class="div-pro-line">
          ...
          <a style="color: #409eff" @click="goExamine(orderDetailDataList.applyRefundId)" class="span-item-value">{{
      ...
      <div class="div-up-content" style="padding-bottom: 10px">
        <div class="div-pro-line">
          <span class="span-item-name">处方订单号 :</span>
    ...
    <script>
import { getOrderDetail, cancelOrder, applyRefund } from '@/api/modular/system/posManage'
