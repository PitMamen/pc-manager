    ...
    <a-card :bordered="false">
      ...
      <div class="div-kuang" style="margin-top: 15px">
        ...
        <div class="div-line" style="margin-bottom: 10px">
          <div
            class="div-cell"
            style="width: 100%; align-items: baseline; margin-left: 0.3%"
          >
            <div class="div-cell-name">
              <span style="color: #f90505">*</span>注意事项：
            </div>
            <div class="div-cell-value" style="width: 100%">
              {{ dataInfo.notice || "" }}
            </div>
        ...
        <div class="div-line" style="margin-bottom: 10px">
          ...
          <div class="div-cell" style="margin-left: 2.6%">
            <div class="div-cell-name" style="width: 120px">
              <span style="color: #f90505">*</span>期望到院时间：
            </div>
            <div class="div-cell-value" style="width: 100%">
              {{
                dataInfo.reachBeginDate
                  ? dataInfo.reachBeginDate + "-" + dataInfo.reachEndDate
                  : ""
              }}
            </div>
          </div>
