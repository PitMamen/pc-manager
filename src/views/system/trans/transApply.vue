      ...
      <div class="div-kuang">
        ...
        <div class="div-line">
          <div class="div-cell">
            ...
            <div class="div-cell-value">高昂哈</div>
          </div>
          <div class="div-cell">
            <div class="div-cell-name"><span style="color: #f90505">*</span>身份证：</div>
            <div class="div-cell-value">320281199112257845</div>
          </div>
          <div class="div-cell">
            <div class="div-cell-name"><span style="color: #f90505">*</span>性别：</div>
            <div class="div-cell-value">男</div>
          </div>

          <div class="div-cell">
            <div class="div-cell-name"><span style="color: #f90505">*</span>出生日期：</div>
            <div class="div-cell-value">1994-02-01</div>
          </div>
        </div>
        <div class="div-line">
          <div class="div-cell">
            <div class="div-cell-name"><span style="color: #f90505">*</span>本人电话：</div>
            <div class="div-cell-value">13544030237</div>
          </div>
          <div class="div-cell">
            <div class="div-cell-name"><span style="color: #f90505">*</span>联系人姓名：</div>
            <div class="div-cell-value">嘻嘻哈哈</div>
          </div>
          <div class="div-cell">
            <div class="div-cell-name"><span style="color: #f90505">*</span>联系人电话：</div>
            <div class="div-cell-value">18710025155</div>
          </div>

          <div class="div-cell">
            <div class="div-cell-name"><span style="color: #f90505">*</span>国籍：</div>
            <div class="div-cell-value">中国</div>
          </div>
        </div>

        <div class="div-line">
          <div class="div-cell">
            <div class="div-cell-name"><span style="color: #f90505">*</span>民族：</div>
            <div class="div-cell-value">土家族</div>
          </div>
          <div class="div-cell">
            <div class="div-cell-name">血型：</div>
            <div class="div-cell-value">A型</div>
          </div>
          <div class="div-cell">
            <div class="div-cell-name">RH阴性：</div>
            <div class="div-cell-value">否</div>
          </div>

          <div class="div-cell">
            <div class="div-cell-name"><span style="color: #f90505">*</span>文化程度：</div>
            <div class="div-cell-value">小学</div>
          </div>
        </div>
        ...
        <div class="div-line">
          <div class="div-cell">
            ...
            <div class="div-cell-value">程序员</div>
          </div>
          <div class="div-cell">
            <div class="div-cell-name">婚姻状况：</div>
            <div class="div-cell-value">未婚</div>
          </div>
          <div class="div-cell">
            <div class="div-cell-name">常住分类：</div>
            <div class="div-cell-value">什么意思</div>
          </div>

          <div class="div-cell">
            <div class="div-cell-name"><span style="color: #f90505">*</span>医保类型：</div>
            <div class="div-cell-value">A级甲等</div>
          </div>
        </div>

        <div class="div-line" style="margin-bottom: 10px">
          <div class="div-cell">
            <div class="div-cell-name">户口住址：</div>
            <div class="div-cell-value">山东省济南市</div>
          </div>
          <div class="div-cell">
            <div class="div-cell-name">户口详细地址：</div>
            <div class="div-cell-value">大雁村12号</div>
          </div>
        </div>
      </div>
      ...
      <div class="div-kuang" style="margin-top: 15px">
        ...
        <div class="div-line" style="margin-bottom: 10px">
          <div class="div-cell">
            ...
            <div class="div-cell-value">什么登记</div>
          </div>
          <div class="div-cell" style="width: 80%">
            <div class="div-cell-name">主要诊断：</div>
            <div class="div-cell-value" style="width: 100%">高血压他发送时间飞机扣罚款客户开发史可法科室咖啡欺负你</div>
          </div>
        </div>
        ...
        <div class="div-line" style="margin-bottom: 10px">
          <div class="div-cell" style="width: 80%">
            ...
            <div class="div-cell-value">方式发送给放声高歌泵多少个人哈尔计划接口拐卖妇女盖盖是刚刚下车个更收稻谷</div>
          </div>
        </div>
        ...
        <div class="div-line" style="margin-bottom: 10px">
          <div class="div-cell" style="width: 80%">
            ...
            <div class="div-cell-value">
              什么经过就发方法布局空格kids过期高峰期规范看那个挨罚收款方那是开发反抗发掘开发呢
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="div-kuang" style="margin-top: 15px">
        ...
        <div class="div-line" style="margin-bottom: 10px">
          <div class="div-cell">
            ...
            <div class="div-cell-value">中南大学湘雅二医院</div>
          </div>
          <div class="div-cell">
            <div class="div-cell-name"><span style="color: #f90505">*</span>转诊类型：</div>
            <div class="div-cell-value" style="width: 100%">上转</div>
          </div>
          <div class="div-cell">
            <div class="div-cell-name"><span style="color: #f90505">*</span>转诊原因：</div>
            <div class="div-cell-value" style="width: 100%">这不好的好的发</div>
          </div>
          <div class="div-cell">
            <div class="div-cell-name"><span style="color: #f90505">*</span>转运方式：</div>
            <div class="div-cell-value" style="width: 100%">拖拉机拉的</div>
          </div>
        </div>
        ...
        <div class="div-line" style="margin-bottom: 10px">
          ...
          <div class="div-cell">
            ...
            <div class="div-cell-value" style="width: 100%">2023-11-01</div>
          </div>
          <div class="div-cell">
          ...
          <div class="div-cell">
            ...
            <div class="div-cell-value" style="width: 100%">多运动</div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    countSpecDesc() {
      ...
      this.medicData.specDesc = `${this.medicData.contentCoefficient ? this.medicData.contentCoefficient : ''}${
        this.medicData.dosUom
      }*${this.medicData.minPkgNum}${this.medicData.baseUnitName}/${this.medicData.packingUnit}`
