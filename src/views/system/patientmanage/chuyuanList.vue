...
//   import logDetail from './logDetail'
  import { getWxPushRecordHistory, getDeptsPersonal, getDepts } from '@/api/modular/system/posManage'
    ...
    data() {
      return {
        ...
        loadData: (parameter) => {
          ...
          return getWxPushRecordHistory(Object.assign(parameter, param)).then((res) => {
            if (res.code == 0) {
              var data = {
