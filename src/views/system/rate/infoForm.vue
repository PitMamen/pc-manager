      ...
      <div class="wrap">
        <div class="tabs">
          ...
          <div class="tab tab5" :class="{ active: tab === 5 }" @click="tabClick(5)">
            <img src="@/assets/icons/wenzhen/tab55.png" v-if="tab === 5" />
            <img src="@/assets/icons/wenzhen/tab5.png" v-else />
            <span>评价审核</span>
          </div>
        </div>
        ...
        <div class="content content5" v-show="tab === 5">
          <div class="top">
            ...
            <div class="infos">
              <div class="col">
                <div class="item">
                  ...
                  <div class="rate">
                    <a-rate
                      :count="5"
                      :value="tab5Info.doctorAllAppraise"
                      allowHalf
                      disabled
                    />
                  </div>
                ...
                <div class="item">
                  <span class="name">服务质量：</span>
                  <div class="rate">
                    <a-rate
                      :count="5"
                      :value="tab5Info.serviceMass"
                      allowHalf
                      disabled
                    />
                  </div>
              ...
              <div class="col">
                ...
                <div class="item">
                  <span class="name">系统使用：</span>
                  <div class="rate">
                    <a-rate
                      :count="5"
                      :value="tab5Info.systemUse"
                      allowHalf
                      disabled
                    />
                  </div>
          ...
          <div class="bottom">
            ...
            <div class="infos" v-if="tab5Info.status === 1">
              <a-textarea
                placeholder="请输入审核建议"
                v-model="tab5Info.checktOpinion"
                :maxLength="100"
                :rows="4"
              />
            </div>
              ...
              <div class="infos">
                <div class="col">
                  <div class="item">
                    ...
                    <span class="desc" v-if="tab5Info.status === 2">通过</span>
                    <span class="desc" v-if="tab5Info.status === 3">不通过</span>
                  </div>
                </div>
                <div class="col">
                  <div class="item">
                    <span class="name">审核时间：</span>
                    <span class="desc">{{ tab5Info.checktTime || '--' }}</span>
                  </div>
                </div>
              </div>
              <div class="infos-row">
                <span>{{ tab5Info.checkName || '--' }}：</span>
                <span>{{ tab5Info.checktOpinion || '--' }}</span>
              </div>
            </template>
          </div>
          <div class="btns" v-if="tab5Info.status === 1">
            <div class="btn pass" @click="authRate(2)">通过</div>
            <div class="btn unpass" @click="authRate(3)">不通过</div>
          </div>
        </div>
      </div>
...
import { info as info5, update } from '@/api/modular/system/rate'
  ...
  methods: {
    ...
    authRate(status) {
      ...
      update({
        id: this.item.id,
        status: status,
        checktOpinion: this.tab5Info.checktOpinion
      }).then(res => {
        if (res.code === 0){
