    ...
    <a-card :bordered="false" class="card-right">
        ...
        <a-form layout="inline">
          <a-row :gutter="48">
            ...
            <a-col :md="6" :sm="24">
              <a-form-item label="处方状态">
                <a-select allow-clear v-model="queryParams.status" placeholder="请选择处方状态">
          ...
          <a-row :gutter="48">
            ...
            <a-col :md="5" :sm="24">
              ...
              <a-button type="primary" @click="$refs.fangDetail.edit()" v-if="true">查看</a-button>
            </a-col>
          </a-row>
        </a-form>
      </div>
      ...
      >
        <span slot="action" slot-scope="text, record">
          <a @click="$refs.fangDetail.edit(record)">查看</a>
