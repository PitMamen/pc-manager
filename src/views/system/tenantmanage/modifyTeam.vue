      ...
      <div class="div-part">
        <div class="div-part-left">
          ...
          <div class="div-service-user" style="margin-top: 10px; margin-left: 0px; position: relative; height: 52%">
            <span style="margin-top: 10px; width: 83px"> 备注说明:</span>
            <a-textarea
              style="height: 80px; min-height: 80px; margin-top: 10px; margin-left: -20px; width: 84%"
...
export default {
  ...
  methods: {
    ...
    handleSubmit() {
      ...
      this.modifyTeam(this.checkData)
    },
