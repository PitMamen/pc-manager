<template>
    ...
    >
      <div class="div-service-user" style="margin-left:15px" >
        <span class="span-item-name" style="margin-top: 5px;"
          ><span style="color: red">*</span> 所属租户 : </span
        >
        <a-select v-model="queryParamsData.tenantId" placeholder="请选择所属租户" allow-clear style="min-width: 180px;margin-left: 5px;" @select="onSelect">
        ...
        >
        <a-select v-model="queryParamsData.applicationId" placeholder="请选择应用类型" allow-clear style="min-width: 180px;margin-left: 5px;">
      ...
      <div class="div-service-user" style="margin-top: 20px;margin-left:15px">
        <span class="span-item-name" style="margin-top: 5px;"
          ><span style="color: red">*</span> 参数编码 :</span
        >
  ...
  import { getApplicationlist,
  getTenantList,saveSysConfigData } from '@/api/modular/system/posManage'
