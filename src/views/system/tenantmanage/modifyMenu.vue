<template>
  ...
  >
    ...
    <div class="div-service-user" style="margin-top: 10px">
      ...
      <span class="span-item-name" style="margin-top: 5px; margin-left: 40px"
        ><span style="color: red">*</span> 菜单类型 :</span
      >
      <a-select
        style="min-width: 248px; margin-left: 5px"
    ...
    <div class="div-service-user" style="margin-top: 10px">
      ...
      <div class="avator-right">
        ...
        <span style="font-size: 12px; color: #999999; margin-top: 6px; margin-left: 5px"
          >支持扩展名：.png .jpge .jpg</span
        >
      </div>

      <!-- 长图标 -->
      <span v-if="queryParams.menuType == 1" style="margin-top: 5px; margin-left: 34px"
        ><span style="color: red">*</span> 长图标 :</span
      >
      <div v-if="queryParams.menuType == 1" class="avator-right">
        ...
        <span
          v-if="queryParams.menuType == 2"
          style="font-size: 12px; color: #999999; margin-top: 6px; margin-left: 5px"
          >支持扩展名：.png .jpge .jpg</span
        >
      </div>
    </div>
    ...
    <div
      v-if="queryParams.jumpType == '2'"
      class="div-service-user"
      style="margin-top: 10px; margin-left: 10px; position: relative"
    >
...
import { queryHospitalList2, modifyTdShopmallMainpageMenu, getApplicationlist } from '@/api/modular/system/posManage'
...
export default {
  ...
  methods: {
    ...
    modifymenu(record) {
      ...
      this.queryParams.icon = record.icon
      this.queryParams.iconLong = record.iconLong
      this.queryParams.jumpType = record.jumpType
      this.queryParams.jumpUrl = record.jumpUrl
      this.queryParams.menuName = record.menuName
     ...
     * 新增接口调用
     */
    modifyTdShopmallMainpageMenuOut() {
      this.confirmLoading = true
      console.log('bbb:', this.queryParams)
      modifyTdShopmallMainpageMenu(this.queryParams)
        .then((res) => {
    ...
    handleSubmit() {
      ...
      this.modifyTdShopmallMainpageMenuOut()
    },
  },
}
</script>
