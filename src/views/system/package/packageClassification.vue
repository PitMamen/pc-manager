<template>
  <a-card :bordered="false" class="card-right-pac">
    ...
    <div class="table-operator" style="overflow: hidden">
      <a-button icon="plus" style="float: right; margin-right: 0; margin-top: 0px" @click="addClassifi()" @ok="handleOk"
        >新增</a-button
      >
    </div>
...
import { qryCommodityClassifyList, saveCommodityClassify } from '@/api/modular/system/posManage'
