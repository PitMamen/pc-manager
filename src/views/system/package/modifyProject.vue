  ...
  export default {
    ...
    methods: {
      ...
      clearData() {
        ...
        this.checkData.normsModel = ''
        this.checkData.projectType = ''
        this.checkData.factoryId = undefined
        this.checkData.suggestPrice = ''
        this.checkData.unit =''
      ...
      modifyModel(record) {
        ...
        this.checkData.projectType = record.projectType
        this.checkData.factoryId = record.factoryId
        this.checkData.suggestPrice = record.suggestPrice
        ...
        getDictDataForCode()
          .then((res) => {
            if (res.code == 0 && res.data.length > 0) {
              ...
              for (let index = 0; index <this.projectTypeData.length; index++) {
                this.projectTypeData[index].code = Number(this.projectTypeData[index].code)  //转为int类型
              }
            } else {
              this.projectTypeData = res.data
            }
