...
export default {
  ...
  methods: {
    ...
    handleEdit(scope) {
      ...
      var period = scope.row.schePreriod
      var arr = period.split('-')
      scope.row.startTime = arr[0]
      scope.row.endTime = arr[1]
      this.schedulePeriods = deepClone(scope.row)
      // var period = this.schedulePeriods.schePreriod
      // var arr = period.split('-')
      // this.schedulePeriods.startTime = arr[0]
      // this.schedulePeriods.endTime = arr[1]
    },
